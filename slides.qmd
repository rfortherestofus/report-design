...
# {background-image="assets/psc-sample-only-two-pages.png" background-size="contain"}
...
::: {.absolute top=-200 style="font-size: 48px;"}
...
qr_code("https://rfor.us/posit2024slides") |>
  generate_svg("assets/qrcode-slides.svg",
               background = "transparent",
               show = FALSE)

qr_code("https://rfor.us/posit2024repo") |>
  generate_svg("assets/qrcode-repo.svg",
               background = "transparent",
               show = FALSE)
```
