...
![](assets/quarto-default-pdf.png){height=800px fig-align="center"}

---

## Work With Other Tools {background-image="assets/road-split-right.jpg" .inverse}
...
#| eval: false
renderthis::to_gif(
  from = "assets/hartford-report.pdf",
  to = "assets/hartford-report.gif",
  complex_slides = TRUE,
  delay = 10
)

renderthis::to_gif(
  from = "assets/bridgeport-report.pdf",
  to = "assets/bridgeport-report.gif",
  complex_slides = TRUE,
  delay = 10
)
```
...
::: {.column width="50%"}
![](assets/hartford-report.gif){fig-align="center"}
:::

::: {.column width="50%"}
![](assets/bridgeport-report.gif){fig-align="center"}
:::
...
### Create a Layout {.hidden}


![](assets/psc-report-layout.png){height=700px fig-align="center"}

---

### Add Brand Colors {.hidden}


![](assets/psc-report-color.png){height=700px fig-align="center"}

---

### Add Brand Fonts {.hidden}

![](assets/psc-report-font.png){height=700px fig-align="center"}

---

### Add Plots {.hidden}

![](assets/psc-report-plots.png){height=700px fig-align="center"}
...
## Don't Have Brand Fonts? {.center .center-slide}
...
Consequat occaecat mollit velit aliquip. Sunt Lorem cupidatat ad ...
```
...
# Report Design is Just a Set of Small Tweaks {.inverse}

---

::: {.large}
1. Identify brand **colors and fonts**

1. Use typst to create a simple **layout** with your brand colors and fonts

1. Create functions to make **plots**, using brand colors and fonts to make them consistent
:::

::: {.notes}
Tie back to overall concepts (don't use defaults and be consistent)
:::
...
::: {.column width="50%"}
![](assets/qrcode-slides.svg){fig-align="center" fig-height="300px"}

[rfor.us/posit2024slides](https://rfor.us/posit2024slides)
:::

::: {.column width="50%"}
![](assets/qrcode-repo.svg){fig-align="center" fig-height="300px"}

[rfor.us/posit2024repo](https://rfor.us/posit2024repo)
:::
